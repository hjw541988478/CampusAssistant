package cn.edu.university.zfcms.ui.login;
...
import cn.edu.university.zfcms.presenter.login.LoginPresenter;
...
public class LoginActivity extends BaseToolbarActivity implements LoginContract.View {
    ...
    public void showLoginSuccessfulView(User user) {
        ...
        CourseActivity.launch(this, CourseActivity.TYPE_DAY_COURSES);
    }
