...
import cn.edu.university.zfcms.biz.courses.CourseService;
import cn.edu.university.zfcms.biz.electric.ElectricService;
import cn.edu.university.zfcms.biz.login.LoginService;
...
public class BizServiceManager {
    ...
    private BizServiceManager() {
                ...
                .client(client.newBuilder()
                        ...
                        .addInterceptor(chain -> {
                            ...
                            Request.Builder authorised = originalRequest.newBuilder()
                                    ...
                                    .header("Origin",Constant.BASE_ZF_CMS_HOST)
                                    .header("Referer", "http://210.34.213.88/default2.aspx")
                                    .header("User-Agent", Constant.USER_AGENT_DEFAULT);
                        ...
                        .cookieJar(new PersistentCookieJar(new SetCookieCache()
                                , new SharedPrefsCookiePersistor(ZfsoftCampusAsstApp.getInstance()))).build())
                .baseUrl(Constant.BASE_ZF_CMS_HOST)
        ...
        electricRetrofit = new Retrofit.Builder()
                ...
                .addConverterFactory(GsonConverterFactory.create())
                .addCallAdapterFactory(RxJava2CallAdapterFactory.create())
                .baseUrl(Constant.BASE_ELECTRIC_HOST)
                .build();
