...
public class MaterialCalendarView extends FrameLayout {
	...
	private final ViewPager.OnPageChangeListener pageChangeListener = new ViewPager.OnPageChangeListener() {
		...
		public void onPageSelected(int position) {
			...
			if (monthListener != null)
				monthListener.onMonthChanged(currentMonth.getMonth());
			updateUi();
		}
	...
	public MaterialCalendarView(Context context, AttributeSet attrs) {
		...
		LayoutInflater.from(getContext()).inflate(R.layout.cw__calendar_widget,
				this);
		...
		TypedArray a = context.getTheme().obtainStyledAttributes(attrs,
				R.styleable.MaterialCalendarView, 0, 0);
		try {
			setArrowColor(a.getColor(
					R.styleable.MaterialCalendarView_arrowColor, Color.BLACK));
			...
			setShowOtherDates(a.getBoolean(
					R.styleable.MaterialCalendarView_showOtherDates, false));
		} catch (Exception e) {
	...
	public void setOnMonthChagedListener(OnMonthChangedListener lister) {
		this.monthListener = lister;
	}
	...
	/**
	 * @param calendar
	 *            a Calendar set to a day to select
	 */
	...
	/**
	 * @param day
	 *            a CalendarDay to set as selected
	 */
	...
	/**
	 * @param calendar
	 *            a Calendar set to a day to focus the calendar on
	 */
	...
	/**
	 * @param date
	 *            a Date to focus the calendar on
	 */
	...
	/**
	 * @param day
	 *            a CalendarDay to focus the calendar on
	 */
	...
	/**
	 * 
	 * By default, only days of one month are shown. If this is set true, then
	 * days from the previous and next months are used to fill the empty space.
	 * This also controls showing dates outside of the min-max range.
	 * 
	 * @param showOtherDates
	 *            show other days, default is false
	 */
	...
	/**
	 * @return true if days from previous or next months are shown, otherwise
	 *         false.
	 */
	...
	private static class MonthPagerAdapter extends PagerAdapter {
		...
		public Object instantiateItem(ViewGroup container, int position) {
			...
			MonthView monthView = (MonthView) inflater.inflate(
					R.layout.cw__month_view, container, false);
