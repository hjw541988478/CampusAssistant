...
public  class CalendarDay implements Parcelable {
	...
	public CalendarDay(Calendar calendar) {
		this(CalendarUtils.getYear(calendar), CalendarUtils.getMonth(calendar),
				CalendarUtils.getDay(calendar), CalendarUtils
						.getWeekOfYear(calendar));
	}
	 ...
	 *            new instance's year
	 * @param month
	 *            new instance's month as defined by
	 *            {@linkplain java.util.Calendar}
	 * @param day
	 *            new instance's day of month
	 */
	public CalendarDay(int year, int month, int day, int weekOfYear) {
		this.year = year;
		this.month = month;
		this.day = day;
	...
	/**
	 * @return the month of the year as defined by
	 *         {@linkplain java.util.Calendar}
	 */
	public int getMonth() {
		return month;
	...
	/**
	 * @param calendar
	 *            calendar to set date information to
	 */
	...
	/**
	 * @param minDate
	 *            the earliest day, may be null
	 * @param maxDate
	 *            the latest day, may be null
	...
	public String toString() {
		return String.format(Locale.US, "%d%d%d", year,
				month + 1, day);
	}
